...
public function get($nom_attribut){
 ...
 public function __construct($id = NULL, $depart = NULL,$arrivee = NULL,$date = NULL,
  ...
  $sql = "INSERT INTO trajet (id, depart,arrivee, date, nbplaces, prix,conducteur_login)  
  VALUES (:id, :depart, :arrivee, :date, :nbplaces, :prix, conducteur_login";
  ...
  $values = array(
    ...
    "conducteur_login"=> $this->conducteur_login);
